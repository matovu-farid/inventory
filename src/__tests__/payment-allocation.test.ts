...
import { allocatePaymentFifo } from '#/lib/credit/payment-allocation'
...
describe('computeNewSaleStatus', () => {
  it("returns 'settled' when balance hits zero", async () => {
    const { computeNewSaleStatus } =
      await import('#/lib/credit/payment-allocation')
