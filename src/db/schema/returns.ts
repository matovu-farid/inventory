...
export const shopReturnLineRelations = relations(
  shopReturnLines,
  ({ one, many }) => ({
...
export const storeReturnRelations = relations(
  storeReturns,
  ({ one, many }) => ({
    shop: one(shops, { fields: [storeReturns.shopId], references: [shops.id] }),
    store: one(stores, {
      fields: [storeReturns.storeId],
...
export const storeReturnLineRelations = relations(
  storeReturnLines,
  ({ one, many }) => ({
