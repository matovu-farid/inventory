...
/**
 * 90-day redirect shim for the old `/products/$articleNumber` URL.
 *
 ...
 * After 2026-08-24 this file (and src/routes/products/index.tsx) can be
...
export const Route = createFileRoute("/products/$articleNumber")({
  beforeLoad: ({ params }) => {
    throw redirect({
      ...
      params: { articleNumber: params.articleNumber },
      replace: true,
    })
  },
})
