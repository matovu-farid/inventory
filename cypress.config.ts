      ...
      on("task", {
        ...
        async cleanupAllTestData(_: unknown) {
          ...
          try {
            ...
            await client.query(`DELETE FROM shop_return_lines`)
            await client.query(`DELETE FROM shop_returns`)
            await client.query(`DELETE FROM store_return_lines`)
            await client.query(`DELETE FROM store_returns`)
            await client.query(`DELETE FROM transactions`)
            await client.query(`DELETE FROM stock_take_lines`)
            await client.query(`DELETE FROM stock_takes`)
            await client.query(`DELETE FROM shop_sale_lines`)
            ...
            await client.query(`DELETE FROM store_transfer_lines`)
            ...
            await client.query(`DELETE FROM supply_route_lines`)
